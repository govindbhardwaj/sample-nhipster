...
export class Config {
    ...
    'jhipster.mail.from' = 'ms1@localhost';
    'jhipster.swagger.default-include-pattern' = '/api/.*';
    'jhipster.swagger.title' = 'ms1 API';
    'jhipster.swagger.description' = 'ms1 API documentation';
    ...
    'eureka.instance.appname' = 'ms1';
    'eureka.instance.instanceId' = 'ms1:${random.value}';
