...
export class Config {
    ...
    'jhipster.mail.from' = 'ms2@localhost';
    'jhipster.swagger.default-include-pattern' = '/api/.*';
    'jhipster.swagger.title' = 'ms2 API';
    'jhipster.swagger.description' = 'ms2 API documentation';
    ...
    'eureka.instance.appname' = 'ms2';
    'eureka.instance.instanceId' = 'ms2:${random.value}';
